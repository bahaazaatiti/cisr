...
<div class="vid-stage mb-4">
  <?php if ($src): ?>
    <iframe class="vid-frame" src="<?= esc($src) ?>" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen referrerpolicy="strict-origin-when-cross-origin"></iframe>
  <?php else: ?>
