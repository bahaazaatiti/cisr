...
<head>
  ...
  *,*::before,*::after{box-sizing:border-box;border:0 solid var(--border);margin:0;padding:0}
  ...
  .sidebar-sign{position:absolute;inset-block-start:.4rem;inset-inline-end:.4rem;width:2.6rem;height:auto;opacity:.85;pointer-events:none;color:var(--foreground)}
  .home-art{display:flex;justify-content:center;margin:1rem 0}
  .home-art img{display:block;max-width:30%;height:auto;color:var(--foreground)}
  ...
  .ar-mode{font:inherit;border:1px solid var(--border);background:transparent;padding:0 .35em;cursor:pointer;line-height:1.4}
  ...
  .lib-up{font:inherit;border:1px solid var(--border);background:transparent;padding:0 .4em;cursor:pointer;line-height:1.3}
  ...
  .vid-frame{display:block;width:100%;aspect-ratio:16/9;background:#000;border:1px solid var(--border)}
  iframe.vid-frame, video.vid-frame{outline:0}
  .vid-frame-empty{display:flex;align-items:center;justify-content:center}
